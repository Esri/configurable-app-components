...
var ScreenshotViewModel = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, html2canvas(secondNode, __assign({ height: secondNode.offsetHeight }, html2CanvasConfig))];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        secondMapComponent = _a.sent();
                        this._secondMapComponent = secondMapComponent;
                        return [4 /*yield*/, html2canvas(thirdNode, __assign({ height: thirdNode.offsetHeight }, html2CanvasConfig))];
                    case 3:
    ...
    ], ScreenshotViewModel.prototype, "state");
    __decorate([
        decorators_1.property()
    ], ScreenshotViewModel.prototype, "outputLayout");
    __decorate([
        decorators_1.property()
    ], ScreenshotViewModel.prototype, "custom");
    __decorate([
        decorators_1.property()
    ], ScreenshotViewModel.prototype, "dragHandler");
    __decorate([
        decorators_1.property()
    ], ScreenshotViewModel.prototype, "enableLegendOption");
    __decorate([
        decorators_1.property()
    ], ScreenshotViewModel.prototype, "enablePopupOption");
    __decorate([
        decorators_1.property({
            readOnly: true
        })
    ], ScreenshotViewModel.prototype, "featureWidget");
    __decorate([
        decorators_1.property()
    ], ScreenshotViewModel.prototype, "includeCustomInScreenshot");
    __decorate([
        decorators_1.property()
    ], ScreenshotViewModel.prototype, "includeLegendInScreenshot");
    __decorate([
        decorators_1.property()
    ], ScreenshotViewModel.prototype, "includePopupInScreenshot");
    __decorate([
        decorators_1.property({
            readOnly: true
        })
    ], ScreenshotViewModel.prototype, "legendWidget");
    __decorate([
        decorators_1.property()
    ], ScreenshotViewModel.prototype, "previewTitleInputNode");
    __decorate([
        decorators_1.property()
    ], ScreenshotViewModel.prototype, "previewIsVisible");
    __decorate([
        decorators_1.property()
    ], ScreenshotViewModel.prototype, "screenshotModeIsActive");
    __decorate([
        decorators_1.property()
    ], ScreenshotViewModel.prototype, "view");
    ScreenshotViewModel = __decorate([
        decorators_1.subclass("ScreenshotViewModel")
    ], ScreenshotViewModel);
    return ScreenshotViewModel;
}(Accessor));
module.exports = ScreenshotViewModel;
